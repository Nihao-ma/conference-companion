    ...
    sat: [
      ...
      { time: "10:30–12:00", parallel: true, items: [
        ...
        { id: "s_c03", b: "con", l: "C03", title: "C03 生物資訊與機器學習",
          tags: [],
          speakers: ["（詳見大會APP）"],
          detail: "AI輔助變異分類工具比較；深度學習判讀基因組變異；臨床分析管道（pipeline）自動化與標準化；臨床生物資訊最佳實踐。",
          link: "https://cattendee.abstractsonline.com/meeting/21531/pages/Scientific_Programme" },
        ...
        { id: "s_c05", b: "con", l: "C05", title: "C05 心臟與血管遺傳",
          tags: [],
          speakers: ["（詳見大會APP）"],
          detail: "肥厚型心肌病遺傳基礎新研究；心律不整遺傳性通道病變（channelopathy）；家族性高膽固醇血症管理；基因組篩查預防突發心臟猝死。",
          link: "https://cattendee.abstractsonline.com/meeting/21531/pages/Scientific_Programme" },
        { id: "s_c06", b: "con", l: "C06", title: "C06 感覺器官（聽力／視力）",
          tags: [],
          speakers: ["（詳見大會APP）"],
          detail: "遺傳性耳聾基因圖譜更新（GJB2以外）；視網膜色素變性與遺傳性眼疾新進展；基因療法在遺傳性眼病（RPE65、RPGR）；聽覺植入基因選擇考量。",
          link: "https://cattendee.abstractsonline.com/meeting/21531/pages/Scientific_Programme" },
        { id: "s_c07", b: "con", l: "C07", title: "C07 基因組醫學與公衛政策",
          tags: [],
          speakers: ["（詳見大會APP）"],
          detail: "全國性基因組計畫成果（英、丹、愛沙尼亞）；新生兒基因組篩查擴展辯論；基因數據分享倫理框架；基因組醫學的健康不平等議題。",
          link: "https://cattendee.abstractsonline.com/meeting/21531/pages/Scientific_Programme" },
      ]},
    ...
    sun: [
      ...
      { time: "10:30–12:00", parallel: true, items: [
        { id: "u_c15", b: "con", l: "C15", title: "C15 cfDNA與液態切片",
          tags: ["prenatal","star"],
          speakers: ["（詳見大會APP）"],
          detail: "新一代 cfDNA 技術應用；NIPT 偵測範圍擴展（胎盤限制型嵌合體、母體癌症）；液態切片在早期妊娠評估；多組學 cfDNA 整合分析。\n\n⭐ 產前診斷核心主題",
          link: "https://cattendee.abstractsonline.com/meeting/21531/pages/Scientific_Programme" },
        ...
        { id: "u_c18", b: "con", l: "C18", title: "C18 表觀遺傳與甲基化",
          tags: ["cyto"],
          speakers: ["（詳見大會APP）"],
          detail: "DNA甲基化圖譜在疾病診斷；表觀遺傳時鐘（epigenetic clock）應用；組蛋白修飾在發育疾病；表觀遺傳療法新進展。",
          link: "https://cattendee.abstractsonline.com/meeting/21531/pages/Scientific_Programme" },
        { id: "u_c19", b: "con", l: "C19", title: "C19 神經遺傳與肌肉疾病",
          tags: [],
          speakers: ["（詳見大會APP）"],
          detail: "肌萎縮性側索硬化症（ALS）新基因研究；脊髓肌萎縮（SMA）治療長期追蹤；遺傳性肌病基因治療；周邊神經疾病基因圖譜。",
          link: "https://cattendee.abstractsonline.com/meeting/21531/pages/Scientific_Programme" },
        { id: "u_c20", b: "con", l: "C20", title: "C20 藥物遺傳學",
          tags: [],
          speakers: ["（詳見大會APP）"],
          detail: "PGx臨床實施成果（荷蘭DPWG、美國CPIC）；藥物基因組學在精神科用藥；癌症精準用藥新生物標記；PGx在兒科的特殊考量。",
          link: "https://cattendee.abstractsonline.com/meeting/21531/pages/Scientific_Programme" },
        { id: "u_c21", b: "con", l: "C21", title: "C21 遺傳諮詢新議題",
          tags: [],
          speakers: ["（詳見大會APP）"],
          detail: "次要發現（secondary findings）通知實務；基因組結果回饋給未成年人的倫理；遠距遺傳諮詢模式評估；AI輔助遺傳諮詢工具。",
          link: "https://cattendee.abstractsonline.com/meeting/21531/pages/Scientific_Programme" },
      ]},
      { time: "17:00–18:30", parallel: true, items: [
        { id: "u_c22", b: "con", l: "C22", title: "C22 染色體結構異常",
          tags: ["cyto","star"],
          speakers: ["（詳見大會APP）"],
          detail: "複雜染色體重排（CCR）解析；染色體碎裂（chromothripsis）新病例；長讀長定序偵測隱匿性易位；平衡易位攜帶者的生育風險精算。\n\n🔬 細胞遺傳核心主題",
          link: "https://cattendee.abstractsonline.com/meeting/21531/pages/Scientific_Programme" },
        { id: "u_c23", b: "con", l: "C23", title: "C23 代謝與溶酶體疾病",
          tags: [],
          speakers: ["（詳見大會APP）"],
          detail: "溶酶體儲積症基因治療最新試驗；有機酸尿症/脂肪酸氧化缺陷新生兒篩查擴展；苯丙酮尿症飲食管理基因輔助；代謝疾病生物標記開發。",
          link: "https://cattendee.abstractsonline.com/meeting/21531/pages/Scientific_Programme" },
        { id: "u_c24", b: "con", l: "C24", title: "C24 基因治療臨床進展",
          tags: [],
          speakers: ["（詳見大會APP）"],
          detail: "AAV基因治療長期追蹤安全性數據；血友病基因治療實際成效；鐮刀型貧血/地中海貧血基因治療全球更新；體內基因編輯（in vivo）首批臨床結果。",
          link: "https://cattendee.abstractsonline.com/meeting/21531/pages/Scientific_Programme" },
        { id: "u_c25", b: "con", l: "C25", title: "C25 複雜多基因疾病",
          tags: [],
          speakers: ["（詳見大會APP）"],
          detail: "多基因風險評分（PRS）在常見病的臨床效用；糖尿病/高血壓遺傳架構更新；多表型GWAS新方法；環境與基因交互作用模型。",
          link: "https://cattendee.abstractsonline.com/meeting/21531/pages/Scientific_Programme" },
        { id: "u_c26", b: "con", l: "C26", title: "C26 粒線體遺傳疾病",
          tags: [],
          speakers: ["（詳見大會APP）"],
          detail: "粒線體DNA突變負荷（heteroplasmy）動態；粒線體替代療法（MRT）倫理辯論更新；核基因編碼粒線體疾病的WES診斷率；粒線體基因編輯可行性。",
          link: "https://cattendee.abstractsonline.com/meeting/21531/pages/Scientific_Programme" },
        { id: "u_c27", b: "con", l: "C27", title: "C27 免疫與自體免疫遺傳",
          tags: [],
          speakers: ["（詳見大會APP）"],
          detail: "原發性免疫缺乏（PID）基因診斷擴展；自體炎症疾病新致病基因；HLA複雜區域精細分型；免疫療法的遺傳預測標記。",
          link: "https://cattendee.abstractsonline.com/meeting/21531/pages/Scientific_Programme" },
        { id: "u_c28", b: "con", l: "C28", title: "C28 功能基因組學方法",
          tags: [],
          speakers: ["（詳見大會APP）"],
          detail: "CRISPR功能篩選（functional screen）在變異致病性評估；單細胞多組學整合；空間轉錄組學（spatial transcriptomics）在人類發育；基因組調控元件解析。",
          link: "https://cattendee.abstractsonline.com/meeting/21531/pages/Scientific_Programme" },
      ]},
    ],
    ...
    mon: [
      ...
      { time: "10:30–12:00", parallel: true, items: [
        { id: "m_c29", b: "con", l: "C29", title: "C29 產前基因組診斷進展",
          tags: ["prenatal","star"],
          speakers: ["（詳見大會APP）"],
          detail: "胎兒基因組分析的臨床路徑優化；超音波異常胎兒的快速WES/WGS；胎盤嵌合體（confined placental mosaicism）處理流程；不確定臨床意義變異（VUS）在產前的管理。\n\n⭐ 本場最重要並行選擇之一",
          link: "https://cattendee.abstractsonline.com/meeting/21531/pages/Scientific_Programme" },
        { id: "m_c30", b: "con", l: "C30", title: "C30 結構性基因組變異",
          tags: ["cyto","star"],
          speakers: ["（詳見大會APP）"],
          detail: "長讀長定序在SV偵測精度比較；複雜重排（複製增益、缺失、倒位組合）完整解析；微陣列 vs WGS在臨床SV診斷；拷貝數變異致病性新分類標準。\n\n🔬 細胞遺傳核心主題",
          link: "https://cattendee.abstractsonline.com/meeting/21531/pages/Scientific_Programme" },
        { id: "m_c31", b: "con", l: "C31", title: "C31 RNA研究與剪接變異",
          tags: [],
          speakers: ["（詳見大會APP）"],
          detail: "RNA定序在診斷困難病例的附加診斷率；深度內含子剪接變異偵測工具比較；轉錄本長讀長定序（IsoSeq）在臨床；異常剪接的mRNA監控機制（NMD）。",
          link: "https://cattendee.abstractsonline.com/meeting/21531/pages/Scientific_Programme" },
        { id: "m_c32", b: "con", l: "C32", title: "C32 癌症體細胞突變",
          tags: [],
          speakers: ["（詳見大會APP）"],
          detail: "腫瘤全基因組定序在精準治療選擇；液態切片ctDNA監測治療反應；腫瘤突變負荷（TMB）與MSI作為免疫治療生物標記；體細胞vs胚系區分挑戰。",
          link: "https://cattendee.abstractsonline.com/meeting/21531/pages/Scientific_Programme" },
        { id: "m_c33", b: "con", l: "C33", title: "C33 遲發型神經退化疾病",
          tags: [],
          speakers: ["（詳見大會APP）"],
          detail: "帕金森氏症遺傳多樣性（LRRK2/GBA/SNCA）；阿茲海默症風險基因與APOE4交互作用；額顳葉失智症（FTD）新致病基因；神經退化疾病生物標記血液檢測。",
          link: "https://cattendee.abstractsonline.com/meeting/21531/pages/Scientific_Programme" },
        { id: "m_c34", b: "con", l: "C34", title: "C34 基因組醫學整合與政策",
          tags: [],
          speakers: ["（詳見大會APP）"],
          detail: "基因組醫學納入國家醫療體系的障礙與解方；臨床醫師基因組識讀（genomic literacy）教育；再分析（re-analysis）策略與頻率；全球基因組數據共享政策框架（GA4GH）。",
          link: "https://cattendee.abstractsonline.com/meeting/21531/pages/Scientific_Programme" },
        { id: "m_c35", b: "con", l: "C35", title: "C35 機器學習與精準醫學",
          tags: [],
          speakers: ["（詳見大會APP）"],
          detail: "大型語言模型在臨床基因組學；表型驅動基因優先化工具新評估；多模態AI整合基因組與影像；聯邦學習（federated learning）在基因組數據共享。",
          link: "https://cattendee.abstractsonline.com/meeting/21531/pages/Scientific_Programme" },
      ]},
    ...
    tue: [
      ...
      { time: "11:00–12:30", parallel: true, items: [
        ...
        { id: "t_c37", b: "con", l: "C37", title: "C37 基因編輯臨床成果",
          tags: [],
          speakers: ["（詳見大會APP）"],
          detail: "鐮刀型貧血/β-地貧 CRISPR治療（CTX001/exa-cel）兩年追蹤；鹼基編輯（base editing）首批人體試驗；先天代謝異常體內基因編輯；脫靶效應長期安全監測。",
          link: "https://cattendee.abstractsonline.com/meeting/21531/pages/Scientific_Programme" },
        { id: "t_c38", b: "con", l: "C38", title: "C38 罕見病登記與患者夥伴",
          tags: [],
          speakers: ["（詳見大會APP）"],
          detail: "歐盟ERN（歐洲參考網絡）成果評估；患者組織參與研究的新模式；罕見病自然病史研究；跨國數據共享加速診斷。",
          link: "https://cattendee.abstractsonline.com/meeting/21531/pages/Scientific_Programme" },
        { id: "t_c39", b: "con", l: "C39", title: "C39 無創診斷技術前沿",
          tags: ["prenatal"],
          speakers: ["（詳見大會APP）"],
          detail: "單分子定序在cfDNA低豐度偵測；甲基化組（methylome）分析識別組織來源；RNA in cfDNA的疾病訊號；母血循環胎兒細胞（cffDNA beyond NIPT）。",
          link: "https://cattendee.abstractsonline.com/meeting/21531/pages/Scientific_Programme" },
        { id: "t_c40", b: "con", l: "C40", title: "C40 基因組醫學實施挑戰",
          tags: [],
          speakers: ["（詳見大會APP）"],
          detail: "中低收入國家基因組醫學可及性；遺傳檢測費用給付政策；臨床醫師訓練需求評估；患者基因識讀（genetic literacy）促進策略。",
          link: "https://cattendee.abstractsonline.com/meeting/21531/pages/Scientific_Programme" },
        { id: "t_c41", b: "con", l: "C41", title: "C41 多元族群健康公平",
          tags: [],
          speakers: ["（詳見大會APP）"],
          detail: "亞洲/非洲/拉丁美洲基因組代表性不足問題；H3Africa、Genomics Japan等大型多元族群計畫；PRS跨族群校正進展；遺傳診斷在不同族群的表現差異。",
          link: "https://cattendee.abstractsonline.com/meeting/21531/pages/Scientific_Programme" },
      ]},
